# 30-fundmatch - Base Native Architecture
...
Quadratic funding matcher

## Overview

FundMatch provides a decentralized solution for matching donations with quadratic formula on both Base (EVM) and Stacks blockchains.
